<div class="comments-body">
  ...
  <?php else: ?>
    <div class="comments-note">
      ...
      <p>However, since extensions are separate from layout, I have to make things clear. The following are some of the criteria to indicate that you are currently using the comment feature on the layout/theme you are selling:</p>
      <ol>
        <li>Your client wants a comment feature on your layout/theme and you make that happen.</li>
      ...
      <p>Please add your intention in making the donation, which is to use this comment feature on a layout/theme that you are selling. It will be even better if you show me the demo page or sales page of your layout/theme. I am very interested in seeing what works you have made using this content management system.</p>
